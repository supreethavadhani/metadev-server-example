...
/** generated class for UnassignStaffSectionSql */
public class UnassignStaffSectionSql extends WriteSql {
	private static final String SQL = "delete from assigned_staffs where institute_id=? and offered_subject_id=? and section_id=?";
	...
	/** default constructor */
	public UnassignStaffSectionSql() {
		this.sqlText = SQL;

...
/** generated class for UnregisterStudentSectionSql */
public class UnregisterStudentSectionSql extends WriteSql {
	private static final String SQL = "delete from subject_registers where institute_id=? and offered_subject_id=? and section_id=?";
	...
	/** default constructor */
	public UnregisterStudentSectionSql() {
		this.sqlText = SQL;

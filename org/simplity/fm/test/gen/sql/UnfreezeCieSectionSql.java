...
/** generated class for UnfreezeCieSectionSql */
public class UnfreezeCieSectionSql extends WriteSql {
	private static final String SQL = "update subject_sections set cie_frozen=false where subject_section_id=?";
	private static final Field[] IN = {
			new Field("subjectSectionId", 0, DefinedDataTypes.id, null, null, null, false)};

	/** default constructor */
	public UnfreezeCieSectionSql() {
		this.sqlText = SQL;

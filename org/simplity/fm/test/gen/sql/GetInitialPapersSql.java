...
/** generated class for GetInitialPapersSql */
public class GetInitialPapersSql extends FilterWithSchemaSql<PaperToCodeDataTable> {
	private static final String SQL = "where offered_subject_id=? and is_makeup=? and institute_id=?";

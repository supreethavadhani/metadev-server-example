...
/** generated class for UnregisterStudentSubjectSql */
public class UnregisterStudentSubjectSql extends WriteSql {
	private static final String SQL = "delete from subject_registers where institute_id=? and offered_subject_id=?";
	...
	/** default constructor */
	public UnregisterStudentSubjectSql() {
		this.sqlText = SQL;

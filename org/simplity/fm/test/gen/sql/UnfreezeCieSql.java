...
/** generated class for UnfreezeCieSql */
public class UnfreezeCieSql extends WriteSql {
	private static final String SQL = "update seasons set cie_entry_frozen=false where season_id=?";
	private static final Field[] IN = {
			new Field("seasonId", 0, DefinedDataTypes.id, null, null, null, false)};

	/** default constructor */
	public UnfreezeCieSql() {
		this.sqlText = SQL;

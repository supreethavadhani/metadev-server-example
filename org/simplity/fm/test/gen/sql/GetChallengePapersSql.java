...
/** generated class for GetChallengePapersSql */
public class GetChallengePapersSql extends FilterWithSchemaSql<PaperToCodeDataTable> {
	private static final String SQL = "where offered_subject_id=? and is_makeup=? and institute_id=? and opted_to_challenge=true";

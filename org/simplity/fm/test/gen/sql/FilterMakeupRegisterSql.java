...
/** generated class for FilterMakeupRegisterSql */
public class FilterMakeupRegisterSql extends FilterWithSchemaSql<ExamRegisterDataTable> {
	private static final String SQL = "where offered_subject_id=? and institute_id=? and has_opted_for_makeup=true order by usn";
	...
	/** default constructor */
	public FilterMakeupRegisterSql() {
		this.sqlText = SQL;

...
/** generated class for UnfreezeAttendanceSubjectSql */
public class UnfreezeAttendanceSubjectSql extends WriteSql {
	private static final String SQL = "update offered_subjects set attendance_frozen=false where offered_subject_id=?";
	private static final Field[] IN = {
			new Field("offeredSubjectId", 0, DefinedDataTypes.id, null, null, null, false)};

	/** default constructor */
	public UnfreezeAttendanceSubjectSql() {
		this.sqlText = SQL;

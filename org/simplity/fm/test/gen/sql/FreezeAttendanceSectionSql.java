...
/** generated class for FreezeAttendanceSectionSql */
public class FreezeAttendanceSectionSql extends WriteSql {
	private static final String SQL = "update subject_sections set attendance_frozen=true where subject_section_id=?";
	private static final Field[] IN = {
			new Field("subjectSectionId", 0, DefinedDataTypes.id, null, null, null, false)};

	/** default constructor */
	public FreezeAttendanceSectionSql() {
		this.sqlText = SQL;

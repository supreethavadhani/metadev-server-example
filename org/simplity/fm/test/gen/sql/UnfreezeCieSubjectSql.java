...
/** generated class for UnfreezeCieSubjectSql */
public class UnfreezeCieSubjectSql extends WriteSql {
	private static final String SQL = "update offered_subjects set cie_frozen=false where offered_subject_id=?";
	private static final Field[] IN = {
			new Field("offeredSubjectId", 0, DefinedDataTypes.id, null, null, null, false)};

	/** default constructor */
	public UnfreezeCieSubjectSql() {
		this.sqlText = SQL;

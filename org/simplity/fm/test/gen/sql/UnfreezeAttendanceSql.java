...
/** generated class for UnfreezeAttendanceSql */
public class UnfreezeAttendanceSql extends WriteSql {
	private static final String SQL = "update seasons set attendance_entry_frozen=false where season_id=?";
	private static final Field[] IN = {
			new Field("seasonId", 0, DefinedDataTypes.id, null, null, null, false)};

	/** default constructor */
	public UnfreezeAttendanceSql() {
		this.sqlText = SQL;

...
/** generated class for UnassignStaffSubjectSql */
public class UnassignStaffSubjectSql extends WriteSql {
	private static final String SQL = "delete from assigned_staffs where institute_id=? and offered_subject_id=?";
	...
	/** default constructor */
	public UnassignStaffSubjectSql() {
		this.sqlText = SQL;

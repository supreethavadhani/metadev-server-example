 ...
 */ 
public class CurrentApprovalData extends SchemaData {

	protected CurrentApprovalData(final CurrentApprovalSchema schema, final Object[] data) {
		super(schema, data);
	}

	@Override
	protected CurrentApprovalData newInstance(final Object[] arr) {
		return new CurrentApprovalData((CurrentApprovalSchema) this.schema, arr);
	}

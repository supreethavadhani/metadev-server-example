...
public class TrustData extends SchemaData {
	...
	protected TrustData(final TrustSchema schema, final Object[] data) {
		super(schema, data);
	}

	@Override
	protected TrustData newInstance(final Object[] arr) {
		return new TrustData((TrustSchema) this.schema, arr);
	}

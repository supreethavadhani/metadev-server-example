 ...
 */ 
public class PacketRecieveData extends SchemaData {

	protected PacketRecieveData(final PacketRecieveSchema schema, final Object[] data) {
		super(schema, data);
	}

	@Override
	protected PacketRecieveData newInstance(final Object[] arr) {
		return new PacketRecieveData((PacketRecieveSchema) this.schema, arr);
	}

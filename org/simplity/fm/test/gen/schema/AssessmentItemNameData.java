 ...
 */ 
public class AssessmentItemNameData extends SchemaData {

	protected AssessmentItemNameData(final AssessmentItemNameSchema schema, final Object[] data) {
		super(schema, data);
	}

	@Override
	protected AssessmentItemNameData newInstance(final Object[] arr) {
		return new AssessmentItemNameData((AssessmentItemNameSchema) this.schema, arr);
	}

 ...
 */ 
public class AssessmentSchemeSelectionData extends SchemaData {

	protected AssessmentSchemeSelectionData(final AssessmentSchemeSelectionSchema schema, final Object[] data) {
		super(schema, data);
	}

	@Override
	protected AssessmentSchemeSelectionData newInstance(final Object[] arr) {
		return new AssessmentSchemeSelectionData((AssessmentSchemeSelectionSchema) this.schema, arr);
	}

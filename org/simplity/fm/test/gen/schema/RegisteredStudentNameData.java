 ...
 */ 
public class RegisteredStudentNameData extends SchemaData {

	protected RegisteredStudentNameData(final RegisteredStudentNameSchema schema, final Object[] data) {
		super(schema, data);
	}

	@Override
	protected RegisteredStudentNameData newInstance(final Object[] arr) {
		return new RegisteredStudentNameData((RegisteredStudentNameSchema) this.schema, arr);
	}

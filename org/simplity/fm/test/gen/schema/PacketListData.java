 ...
 */ 
public class PacketListData extends SchemaData {

	protected PacketListData(final PacketListSchema schema, final Object[] data) {
		super(schema, data);
	}

	@Override
	protected PacketListData newInstance(final Object[] arr) {
		return new PacketListData((PacketListSchema) this.schema, arr);
	}
